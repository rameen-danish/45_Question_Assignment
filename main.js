...
var message = "".concat(famous_person, " once said, \"Whatever you are, be a good one.\"");
console.log(message);
...
var message2 = "My favourite number is ".concat(favourite_Number);
...
console.log("\n \t \t Question11 ");
var names = ["Ayesha", "Areeba", "Zaeema", "Huma", "Sehrish"];
...
console.log("\n \t \t Question12 ");
var names1 = ["Ayesha", "Areeba", "Zaeema", "Huma", "Sehrish"];
for (var i = 0; i < names1.length; i++) {
    console.log("Hello ".concat(names[i], " , Would you like to learn some typescrpit today?"));
}
...
console.log("\n \t \t Question13 ");
var transport = ["Honda Motorcycle", "Toyota Car", "Tesla Car"];
...
console.log("\n \t \t Question14 ");
var guests = ["Bismah", "Rushna", "Daniyal"];
...
console.log("\n \t \t Question15 ");
var unableToAttend = "Daniyal";
console.log("".concat(unableToAttend, " was unable to attend dinner"));
var newGuest = "Faaiz";
...
console.log("\n \t \t Question16 ");
var guest = ["Bismah", "Rushna", "Faaiz"];
console.log("Great news,I found a bigger dinner table.");
guest.unshift("Simrah");
guest.splice(guest.length / 2, 0, "Abeeha");
guest.push("Mairaj");
guest.forEach(function (guest) {
    console.log("Hey Dear ".concat(guest, ", you are invited for dinner"));
});
...
while (guest.length > 2) {
    ...
    console.log("Sorry Dear ".concat(removedGuest, ", I can't invite you for the dinner"));
}
guest.forEach(function (guest) {
    console.log("Hey Dear ".concat(guest, ", you are still invited for the dinner "));
});
...
console.log("\n \t \t Question18 ");
var places = ["Makkah", "Madina", "Turkey", "Canada", "Dubai"];
...
console.log("\n \t \t Question19 ");
var Guest = ["Bismah", "Rushna", "Faaiz", "Daniyal", "Abeeha"];
console.log("".concat(Guest.length, " guests are invited for the dinner."));
...
console.log("I would like to learn these languages : [".concat(languages, "]"));
...
console.log("Mobile Info:".concat(mobile.model, " was released on ").concat(mobile.releaseDate, ", and the price of this mobile is PKR ").concat(mobile.price));
...
console.log("\n \t \t Question22 ");
var iceCream = ["vanilla", "chocolate", "kulfa", "pista"];
console.log("I would like to eat ".concat(iceCream[4], " ice cream")); // Intentional error: Arrays are zero-indexed, so index 4 is out of bounds.
console.log("I would like to eat ".concat(iceCream[1], " ice cream")); // Correcting the error by accessing a valid index.
...
console.log("\n \t \t Question29 ");
var favourite_fruits = ["Mango", "Pear", "Strawberry", "Apple", "Orange"];
...
console.log("\n \t \t Question30 ");
var user_names = ["John", "Eric", "Admin", "Charles", "William"];
...
console.log("\n \t \t Question32 ");
var current_users = ["John", "Eric", "Admin", "Charles", "William"];
var new_users = ["ADmin", "Vicky", "Pascal", "Eric", "John"];
new_users.forEach(function (newUsers) {
    if (current_users.some(function (currentUsers) { return currentUsers.toLowerCase() === newUsers.toLowerCase(); })) {
        console.log("'".concat(newUsers, "' you will need to enter a new user name."));
    }
    else {
...
ordinal.forEach(function (ordinal) {
    var suffix = 'th';
    if (ordinal === 1) {
        suffix = "st";
    }
    ...
    console.log("".concat(ordinal).concat(suffix));
});
...
console.log("\n \t \t Question34 ");
var pizza = ["Fajita", "Afghani", "Cheesy"];
...
function make_shirts(size, message) {
    console.log("Make a '".concat(size, "' size shirt and print a message '").concat(message, "' on the front side of the shirt."));
}
...
console.log("\n \t \t Question41 ");
var magicians_name = ["David", "John", "Chris", "Max"];
...
function makes_great(magicians_name) {
    var greatMagician = [];
    magicians_name.forEach(function (magicians_name) {
        greatMagician.push("".concat(magicians_name, " , the Great Magician"));
    });
    return greatMagician;
}
var greatMagician = makes_great(magicians_name.slice()); //creates a new modified array
